        ...
        <div class="row">
            <div class="col-md-6 offset-3">
                <div class="my-3 text-end">
                   <a href="{{ route('customer#list')}}"> <button class=" btn btn-primary">List Page</button></a>
                </div>

                <div class="card">
                    <div class="card-header text-center fs-3 bg-primary text-white">Customer Register Form</div>
                    <div class="card-body">
                        ...
                        <form action="{{route('customer#create')}}" method="POST">
                            ...
                            <div class="my-2 float-end">
                                <input type="submit" value="Register" class="btn bg-primary text-white">
                            </div>
                        </form>
                    </div>
                </div>
